...
const Header: FC<HeaderProps> = ({ userId, loggedIn, logOut }) => {
    ...
    <header className="header">
      <div className="header-overflow">
        <a className="header-logo">
          <img className="header-logo__image" src={logoImage} alt="Logo"></img>
        ...
        <div className="header-input-container">
          ...
          <button className="header-input-clear-button">
            <svg
              className="header-input-clear-button__clear-icon"
          ...
          <button className="header-input-button">
            <svg
              className="header-input-button__search-icon"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 -960 960 960"
            >
            ...
            <div className="account">
              <div className="account__avatar">
                <div className="account__avatar-overflow">
                  <img className="account__avatar-overflow__image" src={avatar}></img>
                </div>
              </div>
